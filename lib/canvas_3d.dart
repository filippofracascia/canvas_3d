...
import 'canvas_3d_bindings_generated.dart';
...
const String _libName = 'canvas_3d';

/// The dynamic library in which the symbols for [Canvas3dBindings] can be found.
...
final Canvas3dBindings _bindings = Canvas3dBindings(_dylib);
